...
def test_maximize_rides_with_max_time():
    user_preferences = up.UserPreferences(required_rides=None, avoid_rides=None, min_distinct_rides=None, max_ride_repeats=None, max_time={1: 20}, min_total_rides=None)
    park = ct.OptimizeConstant(rides, wait_times, ride_times, user_preferences)
...
def test_maximize_rides_with_max_ride_repeats():
    user_preferences = up.UserPreferences(required_rides=None, avoid_rides=None, min_distinct_rides=None, max_ride_repeats=2, max_time={1: 30}, min_total_rides=None)
    park = ct.OptimizeConstant(rides, wait_times, ride_times, user_preferences)
    ride_weights = park.set_ride_weights()
    # The solution is unbounded if no max_time_constraint, and so maximize_rides should return None
...
def test_maximize_rides_with_no_max_ride_repeats():
    user_preferences = up.UserPreferences(required_rides=None, avoid_rides=None, min_distinct_rides=None, max_ride_repeats=None, max_time={1: 30}, min_total_rides=None)
    park = ct.OptimizeConstant(rides, wait_times, ride_times, user_preferences)
    ride_weights = park.set_ride_weights()
...
def test_maximize_rides_with_required_rides():
    user_preferences = up.UserPreferences(required_rides=['a'], avoid_rides=None, min_distinct_rides=None, max_ride_repeats=None, max_time={1: 30}, min_total_rides=None)
    park = ct.OptimizeConstant(rides, wait_times, ride_times, user_preferences)
    ride_weights = park.set_ride_weights()
...
def test_maximize_rides_with_avoid_rides():
    user_preferences = up.UserPreferences(required_rides=None, avoid_rides=['b'], min_distinct_rides=None, max_ride_repeats=None, max_time={1: 30}, min_total_rides=None)
    park = ct.OptimizeConstant(rides, wait_times, ride_times, user_preferences)
    ride_weights = park.set_ride_weights()
...
def test_maximize_rides_with_same_required_avoid_rides():
    user_preferences = up.UserPreferences(required_rides=['a'], avoid_rides=['a'], min_distinct_rides=None, max_ride_repeats=None, max_time={1: 30}, min_total_rides=None)
    park = ct.OptimizeConstant(rides, wait_times, ride_times, user_preferences)
    ride_weights = park.set_ride_weights()
...
def test_maximize_rides_with_min_distinct_rides():
    user_preferences = up.UserPreferences(required_rides=None, avoid_rides=None, min_distinct_rides=3, max_ride_repeats=None, max_time={1: 30}, min_total_rides=None)
    park = ct.OptimizeConstant(rides, wait_times, ride_times, user_preferences)
    ride_weights = park.set_ride_weights()
